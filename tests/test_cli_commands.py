...
class HelperBehaviorTests(unittest.TestCase):
    ...
    def test_build_rebased_frame_and_table_output(self):
        ...
        self.assertIn("bin=5m", intraday_txt)
        self.assertIn("09:05", intraday_txt)
        self.assertIn("09:10", intraday_txt)
        self.assertNotIn("Rows sampled for readability", intraday_txt)
